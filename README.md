...
|----------|-----------|---------------------------|
| 📦 **61** public repos | 🔥 **426** commits | ![JavaScript](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%23f1e05a&message=JavaScript%2036%25) |
| 🔥 **858** commits | 📝 **1** issues | ![HTML](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%23e34c26&message=HTML%2029%25) |
...
| 🔀 **189** PRs | $\color{Green}{\textsf{+168,934}}$ lines added | ![TypeScript](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%233178c6&message=TypeScript%208%25) |
| ⭐ **37** stars | $\color{Red}{\textsf{-27,218}}$ lines removed | ![CSS](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%23663399&message=CSS%207%25) |

## 🚀 Most Active Projects (Last Year)

- [mohantyabhijit](https://github.com/mohantyabhijit/mohantyabhijit) - 127 commits, $\color{Green}{\textsf{+1,888}}$ / $\color{Red}{\textsf{-878}}$
- [second-brain](https://github.com/mohantyabhijit/second-brain) - 127 commits, $\color{Green}{\textsf{+69,993}}$ / $\color{Red}{\textsf{-15,371}}$
- [mohantyabhijit.github.io](https://github.com/mohantyabhijit/mohantyabhijit.github.io) - 85 commits, $\color{Green}{\textsf{+45,440}}$ / $\color{Red}{\textsf{-2,637}}$
