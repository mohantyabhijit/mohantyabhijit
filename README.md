...
|----------|-----------|---------------------------|
| 📦 **61** public repos | 🔥 **416** commits | ![JavaScript](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%23f1e05a&message=JavaScript%2033%25) |
| 🔥 **848** commits | 📝 **1** issues | ![HTML](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%23e34c26&message=HTML%2030%25) |
| 📋 **3** issues | 🔀 **111** PRs | ![Go](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%2300ADD8&message=Go%2021%25) |
| 🔀 **189** PRs | $\color{Green}{\textsf{+141,451}}$ lines added | ![TypeScript](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%233178c6&message=TypeScript%209%25) |
| ⭐ **37** stars | $\color{Red}{\textsf{-27,149}}$ lines removed | ![CSS](https://img.shields.io/static/v1?style=flat-square&label=%E2%A0%80&color=555&labelColor=%23663399&message=CSS%207%25) |

## 🚀 Most Active Projects (Last Year)

- [second-brain](https://github.com/mohantyabhijit/second-brain) - 127 commits, $\color{Green}{\textsf{+69,993}}$ / $\color{Red}{\textsf{-15,371}}$
- [mohantyabhijit](https://github.com/mohantyabhijit/mohantyabhijit) - 119 commits, $\color{Green}{\textsf{+1,846}}$ / $\color{Red}{\textsf{-836}}$
- [mohantyabhijit.github.io](https://github.com/mohantyabhijit/mohantyabhijit.github.io) - 83 commits, $\color{Green}{\textsf{+17,999}}$ / $\color{Red}{\textsf{-2,610}}$
